...
export default function App() {
  ...
  const [craDataFromDoc, setCraDataFromDoc] = useState(null)
  ...
  function handleCRAData(craData) {
    setCraDataFromDoc(craData)
    setActiveTab('cra')
  }
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0f172a' }}>
      ...
      <main style={{ maxWidth: '1000px', margin: '0 auto', padding: isMobile ? '1rem 0.75rem 5rem' : '2rem' }}>
        {activeTab === 'cra' && <CRA collaborateur={collaborateur} prefillData={craDataFromDoc} />}
        {activeTab === 'absences' && <Absences collaborateur={collaborateur} />}
        {activeTab === 'documents' && <Documents collaborateur={collaborateur} onCRAData={handleCRAData} />}
